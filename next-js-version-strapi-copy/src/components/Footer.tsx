 ...
 * Uses SVG icons for social media platforms (Twitter, Facebook, Instagram, LinkedIn)
 */
  ...
  return (
    <footer className="layout-footer-container">
      <div className="layout-footer-content">
        <p className="layout-footer-copyright">&copy; <span suppressHydrationWarning>{new Date().getFullYear()}</span> My Blog. All rights reserved.</p>
