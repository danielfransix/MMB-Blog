...
export default function PostCard({ title, href, imageSrc, publishedDate, dateTime, authorName }: PostCardProps) {
  return (
    <article className="post-card-article group">
      <a href={href} className="post-card-link">
        ...
        <div className="post-card-content">
          <h3 className="post-card-title group-hover:text-[var(--hover-green)] font-title line-clamp-2">
            {title}
          </h3>
          <p className="post-card-date">
            ...
            {authorName && (
              <>
                ...
                <span className="opacity-60">By {authorName}</span>
              </>
            )}
          </p>
