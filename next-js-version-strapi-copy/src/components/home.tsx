  ...
  return (
    <div className="home-container">
      ...
      <div className="flex flex-col gap-y-6">
        <h1 className="text-3xl font-semibold sm:text-4xl text-center">
          Popular Posts
        </h1>
        <div className="flex gap-x-2">
          <div className="flex flex-col items-center gap-y-2">
            ...
            <h3 className="font-semibold text-2xl">This is a very nice blogpost</h3>
            <button className="flex items-center gap-x-1 hover:text-[var(--hover-green)] transition-colors">
      ...
      <div className="flex flex-col gap-y-6">
        ...
        <div>
          <h2 className="font-semibold text-3xl">This is a very nice blogpost</h2>
        </div>
        <div className="flex gap-x-2 items-center">
          <div className="flex items-center gap-x-1">
            <Icon icon="mingcute:tag-line" />
